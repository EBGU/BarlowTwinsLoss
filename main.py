...
import lightly
from loss import BarlowTwinsLoss,BarlowTwinsLoss_m2,BarlowTwinsLoss_LLY,BarlowTwinsLoss_LLYm2

from utils import knn_predict, BenchmarkModule
datadir = '/home/harold/Documents/Harold_D206PC_Data/Air/barlowtwins/Cifar10'
num_workers = 8
max_epochs = 800
knn_k = 200
knn_t = 0.1
...
class BartonTwins(BenchmarkModule):
    def __init__(self, dataloader_kNN, gpus, classes, knn_k, knn_t):
        ...
        self.criterion = BarlowTwinsLoss_LLYm2(device=device)
